<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="haolian.admin.index" %>

<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="utf-8" />
		<title>客提威电子商务KTV团购-后台管理系统  </title>
...
<script type="text/javascript">	
    ...
    $(function () {
        ...
        var userdata = localStorage.getItem("userdata");//读取本地储存userdata的JSON数据
        userdata = eval('(' + userdata + ')');//转换JSON数据为对象
        $(".user-info").append(userdata.NikeName);//添加用户别名到右上角
    });
...
<script type="text/javascript">
					...
					<a href="#" class="dropdown-toggle"><i class="icon-picture "></i><span class="menu-text">广告管理 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
						<li class="home"><a href="javascript:void(0)" name="advertising.html" title="广告列表" class="iframeurl"><i class="icon-double-angle-right"></i>广告列表</a></li>
						<li class="home"><a href="javascript:void(0)" name="Sort_ads.html" title="广告分类"  class="iframeurl"><i class="icon-double-angle-right"></i>广告分类</a></li>
							</ul>
						</li>
					<li>
                  ...
                  <li>
                    ...
                    <li class="home"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
						...
						<li><a href="#" class="dropdown-toggle"><i class="icon-edit"></i><span class="menu-text"> 文章管理 </span><b class="arrow icon-angle-down"></b></a>
							...
							<ul class="submenu">
								<li class="home"><a href="javascript:void(0)" name="Systems.aspx" title="系统设置" class="iframeurl"><i class="icon-double-angle-right"></i>系统设置</a></li>
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-group"></i><span class="menu-text"> 用户权限 </span><b class="arrow icon-angle-down"></b></a>
							<ul class="submenu">
                                ...
                                <li class="home"><a href="javascript:void(0)" name="administrator.html" title="用户管理" class="iframeurl"><i class="icon-double-angle-right"></i>用户管理</a></li>
								  <li class="home"><a href="javascript:void(0)" name="admin_info.html" title="当前用户" class="iframeurl"><i class="icon-double-angle-right"></i>当前用户</a></li>
							</ul>
						</li>
					</ul>
...
<!-- /.page-content -->
         ...
         <div class="footer_style" id="footerstyle">  
          <p class="l_f">版权所有：湛江市浩联文化传播有限公司</p>
          <p class="r_f">地址：湛江市赤坎区椹川大道北24号之一402房</p>
         </div>
         <!--修改密码样式-->
